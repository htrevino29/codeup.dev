...
console.log(student.name + " made the following aver grade in HTML: " + (total / htmlGrades.length) + "!");
...
function getAverageGrade(arrayOfNumbers) {
    ...
    getAverageGrade.forEach(function(grade) {
        return average;
    }     
}
console.log(student.name " made a " getAverageGrade(htmlGrades)

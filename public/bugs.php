...
<body>
    ...
    <form method="POST">
        ...
        <label for="employment_status">
            <input type="checkbox" id="employed" name="employment_status[]" value="self_employed">
            Self - Employed
        </label>
        <br>
        
        <label for="employment_status">
            <input type="checkbox" id="employed" name="employment_status[]" value="small_business">
            Employed by a small business (< 50 employees)
        </label>
        <br>
        
        <label for="employment_status">
            <input type="checkbox" id="employed" name="employment_status[]" value="large_business">
